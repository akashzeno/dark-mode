...
function imageMode(color) {
    image1.src = `static/media/images/undraw_proud_coder_${color}.svg`;
    image2.src = `static/media/images/undraw_feeling_proud_${color}.svg`;
    image3.src = `static/media/images/undraw_conceptual_idea_${color}.svg`;
}
